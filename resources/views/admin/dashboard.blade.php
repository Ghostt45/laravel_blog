    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('main') }}" class="nav-link">Main page</a>
            </li>
        </ul>

        <ul class="navbar-nav ml-auto mr-3">
            <li class="nav-item d-none d-sm-inline-block">
                <p style="margin: 0px">{{ Auth::user()->name }}'s page</p>
            </li>
        </ul>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item">
                        <a href="{{ route('admin.users.crud') }}" class="nav-link">
                    ...
                    @if (in_array(Auth::user()->role->role_name, ['superAdmin']))
                        <li class="nav-item">
